...
export interface IOtherFlightsListProps {
    flightInfoOpen: string[],
    setFlightInfoOpen: (id: string[]) => void,
    otherFlightsList: FlightsDataType[] | undefined
}

export const OtherFlightsList = ({ flightInfoOpen, setFlightInfoOpen, otherFlightsList, }: IOtherFlightsListProps) => {
    ...
    return (
        <>
            <h2 className="f-title">Other flights</h2>

            <ul className="flight-list">
                {otherFlightsList?.map((flight, index) => {
                    return (
