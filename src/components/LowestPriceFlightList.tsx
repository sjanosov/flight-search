...
export interface ILowestPriceFlightListProps {
    flightInfoOpen: string[],
    setFlightInfoOpen: (id: string[]) => void,
    lowestPriceFlightList: FlightsDataType[] | undefined;
}

export const LowestPriceFlightList = ({ flightInfoOpen, setFlightInfoOpen, lowestPriceFlightList, }: ILowestPriceFlightListProps) => {
    ...
    return (
        <>
            <h2 className="f-title">Lowest prices</h2>

            <ul className="flight-list">
                {lowestPriceFlightList?.map((flight, index) => {
                    return (
